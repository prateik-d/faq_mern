...
const { Categories, validate } = require('../../models/faq/categories')
...
router.post('/', async (req, res) => 
{
    try 
    {
        ...
        const categories_name = await Categories.findOne({title: req.body.name});
...
router.put('/update/:id', async (req, res) => 
{
    try
    {
        ...
        const categories_name = await Categories.findOne({natitleme: req.body.name});
